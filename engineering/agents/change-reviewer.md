...
- Extension-point contracts: flag non-obvious setup, ordering, state, or cleanup requirements that every sibling extension must repeat. Prefer a shared boundary; otherwise require a registration-point contract with the prerequisite, rationale, and required action.
